...
func performInstallation() {
	...
	updateProgress(0.7)
	if err := exeCmd("releax-post-process", workDir, installData.language, installData.userData.userid, installData.userData.password, installData.efiDir); err != nil {
		glib.IdleAdd(checkErr, err)
	}
